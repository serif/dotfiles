...
" set inccommand=nosplit      "Live preview for :%s/search/replace set incsearch               "Begin searching immediately set lazyredraw              "Redraw only when needed set listchars=tab:»·,trail:· "Display of tabs and trailing spaces
